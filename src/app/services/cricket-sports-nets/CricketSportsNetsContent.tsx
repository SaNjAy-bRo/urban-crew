...
import { PhoneCall, CheckCircle2, ArrowRight, ChevronRight, Trophy, Shield, Ruler, Sun } from 'lucide-react';
...
const features = [
  {
    ...
    description: 'Tournament-quality netting used by sports academies, schools, and professional training facilities.',
  },
  {
    icon: Shield,
    title: 'Impact Resistant',
    description: 'Heavy-duty HDPE netting designed to absorb the impact of cricket balls, footballs, and more.',
  },
  {
    icon: Ruler,
    title: 'Custom Sizing',
    description: 'Tailored to your exact dimensions — whether it\'s a rooftop cricket pitch or a full-sized practice net.',
  },
  {
    icon: Sun,
    title: 'All-Weather Durability',
    description: 'UV-stabilized and weather-proof material that lasts years without sagging, tearing, or fading.',
  },
];

const galleryImages = [
  '/images/sports-gallery-1.jpeg',
  '/images/sports-gallery-2.jpeg',
  '/images/sports-gallery-3.jpeg',
  '/images/sports-gallery-4.jpeg',
  '/images/sports-gallery-5.jpeg',
  '/images/sports-gallery-6.jpeg',
  '/images/sports-gallery-7.jpeg',
  '/images/sports-gallery-8.jpeg',
];

const processSteps = [
  { step: '01', title: 'Consultation', description: 'We discuss your sport, space, and requirements to recommend the perfect netting setup.' },
  { step: '02', title: 'Site Measurement', description: 'Our team visits the location for precise measurements and structural assessment.' },
  { step: '03', title: 'Fabrication & Install', description: 'Custom-fabricated nets are professionally installed with heavy-duty anchoring.' },
  { step: '04', title: 'Warranty & Support', description: 'Full warranty coverage with ongoing support for repairs and adjustments.' },
];

const faqs = [
  {
    q: 'What sports are your nets suitable for?',
    a: 'Our nets are perfect for cricket practice nets, football goal nets, badminton court enclosures, terrace sports areas, swimming pool safety nets, and general sports boundary netting. We customize the mesh size and thickness based on the sport.',
  },
  {
    q: 'Can you install cricket nets on a rooftop or terrace?',
    a: 'Absolutely! Rooftop and terrace cricket net installations are one of our most popular services. We use specialized pole systems and heavy-duty anchoring to create safe, enclosed practice areas on any terrace.',
  },
  {
    q: 'How durable are the sports nets against ball impact?',
    a: 'Our sports nets use heavy-duty HDPE with a higher denier count specifically rated for ball impact. Cricket practice nets can handle repeated leather ball strikes without tearing, with a typical lifespan of 5-8 years.',
  },
  {
    q: 'Do you provide nets for schools and sports academies?',
    a: 'Yes, we\'ve installed nets for numerous schools, coaching academies, and apartment complexes across Bangalore. We offer bulk pricing and can handle large-scale installations efficiently.',
  },
];

export default function CricketSportsNetsContent() {
    ...
    <div className="flex flex-col w-full bg-white text-slate-800">
      ...
      <section className="relative w-full pt-44 pb-14 md:pt-52 md:pb-16 overflow-hidden bg-[#0A192F]">
        <div className="absolute inset-0 z-0">
          <Image src="/images/services/sports-cricket-net.jpeg" alt="Sports Nets" fill priority className="object-cover opacity-20" />
        ...
        <div className="container relative z-20 px-4 md:px-8 mx-auto">
          <div className="flex items-center gap-2 text-xs text-blue-200/60 mb-4 font-medium">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-[#F97316]">Cricket & Sports Nets</span>
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-3 leading-tight tracking-tight">
            Cricket & Sports <span className="text-[#F97316]">Nets</span>
          </h1>
          <p className="text-base sm:text-lg text-blue-100/70 font-medium max-w-2xl mb-6">
            Durable, professional-grade nets for cricket practice, sports courts, and recreational areas.
          </p>
      ...
      <section className="py-16 md:py-24 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-[#1E3A8A] mb-4">Built for Performance</h2>
            <p className="text-lg text-slate-500 font-medium">Professional-grade netting that athletes and sports lovers trust.</p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 max-w-7xl mx-auto">
            <div className="w-full lg:w-1/2">
              <div className="relative aspect-[4/5] sm:aspect-square rounded-[2rem] overflow-hidden shadow-2xl">
                <Image src="/images/cricket1.jpg" alt="Cricket net installation" fill className="object-cover" />
                ...
                <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-md p-4 rounded-2xl shadow-xl flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-slate-800 text-sm">500+ Sports Installations</p>
                    <p className="text-xs text-slate-500 font-medium">Schools, academies & apartments</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-1/2">
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-6 leading-tight">
                Your <span className="text-[#F97316]">Perfect</span> Practice Setup
              </h2>
              <p className="text-lg text-slate-500 font-medium mb-8 leading-relaxed">
                Whether you need a rooftop cricket practice net, a football court enclosure, or a multi-sport boundary net, we deliver custom solutions built to last. Our heavy-duty HDPE nets absorb impact and resist weathering for years of reliable use.
              </p>
              
              <div className="space-y-4 mb-10">
                {[
                  'Heavy-duty HDPP with high denier count',
                  'Cricket, football, badminton & multi-sport',
                  'Rooftop, terrace & ground installations',
                  'Custom pole systems with sturdy anchoring',
                  'Ideal for schools, academies & apartments',
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
            ...
            <p className="text-lg text-slate-500 font-medium">From consultation to a match-ready setup.</p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-[#F8FAFC]">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-[#1E3A8A] mb-4">Sports Net Gallery</h2>
            <p className="text-lg text-slate-500 font-medium">Our installations across Bangalore sports facilities.</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-7xl mx-auto">
            {galleryImages.map((img, idx) => (
              <div key={idx} className="relative aspect-square rounded-2xl overflow-hidden group cursor-pointer shadow-md hover:shadow-xl transition-all duration-500">
                <Image src={img} alt={`Sports net installation ${idx + 1}`} fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-slate-500 font-medium">Common questions about sports netting.</p>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
            <div className="text-white flex-1">
              <h2 className="text-3xl md:text-4xl font-black mb-2">Ready to Set Up Your Sports Net?</h2>
              <p className="text-blue-200 text-lg font-medium">Get a custom quote for your cricket pitch, court, or sports area.</p>
            </div>
